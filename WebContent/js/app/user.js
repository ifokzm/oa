    ...
    user_datagrid = $('#user_datagrid').datagrid({
        ...
        columns : [ 
            [ 
              ...
              {field : 'company',title : '所属公司',width : fixWidth(0.2),align : 'left',sortable: true},
              {field : 'beginDate',title : '开通日期',width : fixWidth(0.2),align : 'left',sortable: true},
              {field : 'endDate',title : '截止日期',width : fixWidth(0.2),align : 'left',sortable: true},
