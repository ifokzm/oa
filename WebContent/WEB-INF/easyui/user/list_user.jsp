			...
			<tr>
				<td style="padding-left:2px">
					<shiro:hasRole name="admin">
						...
						<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-reload" plain="true" onclick="sync();">添加城市</a>|
						<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-reload" plain="true" onclick="sync();">配置城市</a>
					</shiro:hasRole>
			</tr>
		</table>
	</div>
